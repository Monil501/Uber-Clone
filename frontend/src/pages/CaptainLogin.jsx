...
const CaptainLogin = () => {
  ...
  return (
    ...
    <div>
      <Link to="/login" className="bg-[#ef6f06] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 border w-full text-lg placeholder:text-base"
